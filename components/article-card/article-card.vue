<template>
	<view class="article-card" @click="onClick">
		<navigator v-if="mode === 'basic'" :url="url" class="article_link clearfix" hover-class="navigator-hover" hover-stay-time="50">
		...
		<navigator v-if="mode === 'single'" :url="url" class="article_link clearfix middle_mode" hover-class="navigator-hover" hover-stay-time="50">
		...
		<navigator v-if="mode === 'triple'" :url="url" class="article_link clearfix" hover-class="navigator-hover" hover-stay-time="50">
			<view class="item_detail">
				<h3 class="line3 dotdot">{{ title }}</h3>
		...
		<navigator v-if="mode === 'large'" :url="url" class="article_link clearfix" hover-class="navigator-hover" hover-stay-time="50">
			<view class="item_detail">
				<h3 class="line3 dotdot">{{ title }}</h3>
